                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs font-semibold uppercase text-muted-foreground ml-1">아이디</FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs font-semibold uppercase text-muted-foreground ml-1">비밀번호</FormLabel>
                                            <FormControl>
                                                <Input
                                                    type="password"
                                                    placeholder="••••••••"
                                            ...
                                            <div className="flex justify-end">
                                                <Button variant="ghost" className="px-0 font-normal text-xs text-muted-foreground hover:text-primary h-auto hover:bg-transparent hover:underline" type="button" onClick={(e) => { e.preventDefault(); (toast as any)({ title: "알림", description: "관리자에게 문의하세요." }); }}>
                                                    비밀번호를 잊으셨나요?
                                                </Button>
                                            </div>
                                            <FormMessage />
